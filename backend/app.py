...
with app.app_context():
    try:
        ...
        migrations = [
            ...
            "ALTER TABLE focus_sessions ADD COLUMN IF NOT EXISTS xp_earned INTEGER NOT NULL DEFAULT 0;",
            "ALTER TABLE focus_sessions ADD COLUMN IF NOT EXISTS idempotency_key VARCHAR(64);",
            "CREATE INDEX IF NOT EXISTS ix_focus_sessions_idempotency_key ON focus_sessions (idempotency_key);",
...
from routes.room_dock_routes import room_dock
...
app.register_blueprint(room_dock)
